...
$send_email_to = "amit.sharma.tafs@gmail.com";
$email_subject = "Contact from Github Page";
...
if ($_POST['submit']) {
    if (@mail($send_email_to, $email_subject, $message,$headers)) { 
        echo '<p>Your message has been sent!</p>';
